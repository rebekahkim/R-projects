...
Therefore, we fail to reject the null hypothesis; vacancy rate (x3) is not a statistically signficant predictor to the response variable (rental rates) after holding all other variables constant.
...
http://educ.jmu.edu/~chen3lx/math322/chapter4.pdf
http://math-ta-x.utsc.utoronto.ca/stac67/Quiz4_soln.pdf
